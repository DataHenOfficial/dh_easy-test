...
Gem::Specification.new do |spec|
  spec.name          = "dh_easy-test"
  spec.version       = DhEasy::Test::VERSION
  spec.authors       = ["Eduardo Rosales"]
  spec.email         = ["eduardo@datahen.com"]

  spec.summary       = %q{DataHen Easy toolkit test module}
  spec.description   = %q{DataHen Easy toolkit test module to support other complex modules.}
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "https://github.com/DataHenOfficial/dh_easy-test"
