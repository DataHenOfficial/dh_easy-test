  ...
  describe 'unit test' do
    describe 'non json file' do
      it 'should load when exists' do
        Dir.mktmpdir(nil, @temp_dir) do |dir|
          ...
          begin
            ...
            file.write expected
            file.close
            data = DhEasy::Test::Helper.load_file file.path
      ...
      it 'should get nil when not exists' do
        data = DhEasy::Test::Helper.load_file "./test/aaaaaa"
        assert_nil data
      end
    end
    ...
    describe 'json file' do
      it 'should load when exists' do
        Dir.mktmpdir(nil, @temp_dir) do |dir|
          ...
          begin
            ...
            file.close
            data = DhEasy::Test::Helper.load_json_file file.path
            assert_equal expected, data
          ensure
            file.unlink unless file.nil?
          end
      ...
      it 'should get nil when not exists' do
        data = DhEasy::Test::Helper.load_json_file "./test/aaaaaa"
        assert_nil data
      end
    end
    ...
    it "should match element and partial filter when element include filter" do
      ...
      filter = {'b' => 2, 'c' => '3'}
      assert DhEasy::Test::Helper.match?(element, filter, exact_match: false)
    end

    it "should not match element and partial filter when different" do
      element = {'a' => 1, 'b' => 2, 'c' => '3', 'd' => ['d1', 'd2']}
      filter = {'b' => 2, 'c' => '4'}
      refute DhEasy::Test::Helper.match?(element, filter, exact_match: false)
    end

    it "should match element and exact filter when equal" do
      element = {'a' => 1, 'b' => 2, 'c' => '3', 'd' => ['d1', 'd2']}
      filter = {'a' => 1, 'b' => 2, 'c' => '3', 'd' => ['d1', 'd2']}
      assert DhEasy::Test::Helper.match?(element, filter, exact_match: true)
    end

    it "should not match element and exact filter when different" do
      element = {'a' => 1, 'b' => 2, 'c' => '3', 'd' => ['d1', 'd2']}
      filter = {'a' => 1, 'b' => 2, 'c' => '3', 'd' => ['d1', 'd3']}
      refute DhEasy::Test::Helper.match?(element, filter, exact_match: true)
    end
    ...
    it "should delete keys correctly" do
      ...
      keys = ['a', 'd']
      expected = {'b' => 2, 'c' => '3'}
      DhEasy::Test::Helper.delete_keys_from! element, keys
    ...
    it "should sanitize raw hash correctly" do
      ...
      data = DhEasy::Test::Helper.sanitize element, skip_keys: keys
      assert_equal expected, data
    end
    ...
    describe 'match collections' do
      it "should partial match elements within items" do
        ...
        assert DhEasy::Test::Helper.collection_match?(expected, items, exact_match: false)
      end
      ...
      it "should not partial match elements when different" do
        ...
        refute DhEasy::Test::Helper.collection_match?(expected, items, exact_match: false)
      end
      ...
      it "should exact match element when equal" do
        ...
        assert DhEasy::Test::Helper.collection_match?(expected, items)
      end
      ...
      it "should not exact match elements when different" do
        ...
        refute DhEasy::Test::Helper.collection_match?(expected, items)
      end
      ...
      it "should match exact elements when indifferent about item length" do
        ...
        assert DhEasy::Test::Helper.collection_match?(expected, items, same_count: false)
      end
